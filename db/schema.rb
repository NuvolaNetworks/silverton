...
ActiveRecord::Schema.define(version: 20140419182714) do
  ...
  add_index "jobs", ["name", "resource_type", "resource_id"], name: "index_jobs_on_name_and_resource_type_and_resource_id"
  ...
  add_index "users_jobs", ["user_id", "job_id"], name: "index_users_jobs_on_user_id_and_job_id"
